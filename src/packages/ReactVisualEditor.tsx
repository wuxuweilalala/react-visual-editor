...
import {VisualEditorBlockRender, VisualEventContext, VisualSlot} from "./ReactVisualEditorBlock";
...
import {ReactVisualEditorOperator, ReactVisualEditorOperatorInstance} from "./ReactVIsualEditorOperator";
...
export type CustomVisualBlockProps = Record<string, (() => Record<string, any>) | Record<string, any>>

export const ReactVisualEditor: React.FC<{
    value: VisualEditorModelValue,
    option: VisualEditorOption,
    formData: Record<string, any>,
    customBlockProps?: CustomVisualBlockProps,
    preview?: boolean,
    welt?: number,
    ...
    const operator = useRef({} as ReactVisualEditorOperatorInstance)
    ...
    return (<VisualEventContext.Provider value={event}>
            <div className="vue-visual-container"
                ...
                />))}
                <div className="vue-visual-container-edit-button" onClick={methods.openEdit}>
                    <i className="iconfont icon-edit"/>
                    <span>编辑组件</span>
                </div>
            </div>
            {editFlag && <div className={classes}>
                ...
                <ReactVisualEditorOperator
                    ...
                    onChange={handler.onOperatorUpdateModelValue}
                    onBlockChange={handler.onOperatorUpdateBlock}
                    onRef={val => operator.current = val}
                />
